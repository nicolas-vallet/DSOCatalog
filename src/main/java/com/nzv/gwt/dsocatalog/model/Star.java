...
@Entity
@Table(name = "star")
public class Star extends AstroObject implements Serializable {
	...
	@Column(name = "multiple_code", columnDefinition = "char")
	@Enumerated(EnumType.STRING)
	private MultipleStarCode multipleStarCode;
	...
	@Column(name = "parallax_code", columnDefinition = "char")
	@Enumerated(EnumType.STRING)
	private ParallaxCode parallaxCode;
	...
	public MultipleStarCode getMultipleStarCode() {
		return multipleStarCode;
	}

	public void setMultipleStarCode(MultipleStarCode multipleStarCode) {
		this.multipleStarCode = multipleStarCode;
	}
	...
	public ParallaxCode getParallaxCode() {
		return parallaxCode;
	}

	public void setParallaxCode(ParallaxCode parallaxCode) {
		this.parallaxCode = parallaxCode;
	}
